...
void FileInfo::slotGet()
{
    ...
    isDirCheckBox->setCheckState(isFile ? Qt::Checked : Qt::Unchecked);
    isDirCheckBox->setCheckState(isSymLink ? Qt::Checked : Qt::Unchecked);
    isDirCheckBox->setCheckState(isHidden ? Qt::Checked : Qt::Unchecked);
    isDirCheckBox->setCheckState(isReadable ? Qt::Checked : Qt::Unchecked);
    isDirCheckBox->setCheckState(isWritable ? Qt::Checked : Qt::Unchecked);
    isDirCheckBox->setCheckState(isExecutable ? Qt::Checked : Qt::Unchecked);
}
